...
export function AjustesView() {
  ...
  const [formData, setFormData] = useState<Partial<IngenieroLocal>>({
    nombre: "",
    apellidos: "",
    nif: "",
    colegiado: "",
              ...
              <div
                ...
                className={`flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-lg border transition-all ${
                  activo?.id === ing.id
                    ...
                    : "bg-black/20 border-slate-700/50 hover:bg-slate-800/80"
                }`}
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      NIF: {ing.nif} {ing.colegiado ? `| Col: ${ing.colegiado}` : ""}
                    </p>
                  </div>
                </div>
          ...
          <form className="space-y-4" onSubmit={handleGuardar}>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-slate-400">
                Escaneo de Firma (Auto-Crop y limpieza de blancos activo)
              </label>
                ...
                {firmaPreview ? (
                  <div className="relative group">
                    <img
                      src={firmaPreview}
                      alt="Preview firma"
                      className="h-20 w-auto bg-white rounded border border-slate-600 object-contain p-2"
                    />
                    <button
                      type="button"
                      onClick={() => {
                  ...
                  >
                    {isProcessing ? (
                      ...
                      <>
                        ...
                        <span className="text-xs">Subir o tomar foto</span>
                      </>
                    )}
                  </button>
                )}
