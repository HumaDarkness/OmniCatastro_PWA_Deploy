        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl tracking-tight">
              Omni<span className="text-blue-400">Catastro</span> B2B
            </span>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
          <div className="space-y-8">
            ...
            <p className="text-xl text-gray-400 leading-relaxed max-w-lg">
              Diseñado exclusivamente para ingenierías y empresas de aislamiento. Elimina el error
              humano en cálculos CTE DB-HE. Tu seguro de responsabilidad civil te lo agradecerá.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <a
                href="mailto:soporte@omnicatastro.com?subject=Solicitud de Demo B2B - OmniCatastro"
                className="flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-semibold px-8 py-4 rounded-xl shadow-lg shadow-blue-500/25 transition-all group"
              >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            <h2 className="text-3xl lg:text-5xl font-bold mb-6">
              El Dolor de la Burocracia Termina Aquí
            </h2>
            <p className="text-gray-400 text-lg">
              Sabemos que el negocio no está en rellenar PDFs, está en el aislante y en los
              Certificados de Ahorro Energético (CAEs). OmniCatastro convierte meses de papeleo en
              clics.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="glass-panel p-8 rounded-2xl border border-white/5 bg-white/[0.02]">
              ...
              <p className="text-gray-400">
                Arrastra 100 archivos CE3X. Nuestro motor lee las referencias catastrales, cruza
                datos climáticos y saca el certificado. Sin teclear nada.
              </p>
            </div>
            ...
            <div className="glass-panel p-8 rounded-2xl border border-white/5 bg-white/[0.02]">
              ...
              <p className="text-gray-400">
                Usa URSA TERRA, SUPAFIL o el aislante de tu matriz. Los coeficientes U y 'b' se
                calculan solos usando el CTE DB-HE actualizado.
              </p>
            </div>
            ...
            <div className="glass-panel p-8 rounded-2xl border border-white/5 bg-white/[0.02] relative overflow-hidden">
              ...
              <p className="text-gray-400 relative z-10">
                Tus datos y nuestro algoritmo están blindados. El Cloud computing ocurre en
                servidores Enterprise aislados. Tú decides quién tiene acceso (SSO/Google Login).
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-gray-400 text-lg">
              Si cobras 150€ por certificado y tu técnico solo puede hacer 2 al día, estás perdiendo
              dinero. OmniCatastro multiplica esa cifra.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-4xl mx-auto bg-white/[0.02] border border-white/10 rounded-3xl p-8 lg:p-12">
            ...
            <div className="glass-panel p-8 text-center rounded-2xl bg-blue-900/10 border-blue-500/30">
              ...
              <a
                href="mailto:soporte@omnicatastro.com?subject=Reserva de Plaza - Licencia Corporate"
                className="inline-flex w-full items-center justify-center gap-2 bg-white text-black font-bold px-8 py-3.5 rounded-xl hover:bg-gray-200 transition-all active:scale-[0.98]"
              >
                Solicitar Acceso
              </a>
            </div>
