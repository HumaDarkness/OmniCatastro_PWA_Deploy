...
export const ZONES_DATA: Record<string, { limit: number; newZone: string }[]> = {
  Albacete: [
    { limit: 50, newZone: "C3" },
    { limit: 500, newZone: "D3" },
    { limit: 1000, newZone: "E1" },
    { limit: 1301, newZone: "E1" },
  ],
  "Alicante/Alacant": [
    { limit: 250, newZone: "B4" },
    { limit: 700, newZone: "C3" },
    { limit: 1301, newZone: "D3" },
  ],
  Almería: [
    { limit: 100, newZone: "A4" },
    { limit: 250, newZone: "B4" },
    { limit: 400, newZone: "B3" },
    { limit: 800, newZone: "C3" },
    { limit: 1301, newZone: "D3" },
  ],
  "Araba/Álava": [
    { limit: 600, newZone: "D1" },
    { limit: 1301, newZone: "E1" },
  ],
  Asturias: [
    { limit: 50, newZone: "C1" },
    { limit: 550, newZone: "D1" },
    { limit: 1301, newZone: "E1" },
  ],
  Ávila: [
    { limit: 550, newZone: "D2" },
    { limit: 850, newZone: "D1" },
    { limit: 1301, newZone: "E1" },
  ],
  Badajoz: [
    { limit: 400, newZone: "C4" },
    { limit: 450, newZone: "C3" },
    { limit: 1301, newZone: "D3" },
  ],
  "Balears, Illes": [
    { limit: 250, newZone: "B3" },
    { limit: 1301, newZone: "C3" },
  ],
  Barcelona: [
    { limit: 250, newZone: "C2" },
    { limit: 450, newZone: "D2" },
    { limit: 750, newZone: "D1" },
    { limit: 1301, newZone: "E1" },
  ],
  Bizkaia: [
    { limit: 250, newZone: "C1" },
    { limit: 1301, newZone: "D1" },
  ],
  Burgos: [
    { limit: 600, newZone: "D1" },
    { limit: 1301, newZone: "E1" },
  ...
  Cáceres: [
    { limit: 600, newZone: "C4" },
    { limit: 1050, newZone: "D3" },
    { limit: 1301, newZone: "E1" },
  ],
  Cádiz: [
    { limit: 150, newZone: "A3" },
    { limit: 450, newZone: "B3" },
    { limit: 600, newZone: "C3" },
    { limit: 850, newZone: "C2" },
    { limit: 1301, newZone: "D2" },
  ],
  Cantabria: [
    { limit: 150, newZone: "C1" },
    { limit: 650, newZone: "D1" },
    { limit: 1301, newZone: "E1" },
  ],
  "Castellón/Castelló": [
    { limit: 100, newZone: "B3" },
    { limit: 500, newZone: "C3" },
    { limit: 600, newZone: "D3" },
    { limit: 1000, newZone: "D2" },
    { limit: 1301, newZone: "E1" },
  ],
  Ceuta: [{ limit: 1301, newZone: "B3" }],
  "Ciudad Real": [
    { limit: 450, newZone: "C4" },
    { limit: 500, newZone: "C3" },
    { limit: 1301, newZone: "D3" },
  ],
  Córdoba: [
    { limit: 150, newZone: "B4" },
    { limit: 550, newZone: "C4" },
    { limit: 1301, newZone: "D3" },
  ],
  "Coruña, A": [
    { limit: 200, newZone: "C1" },
    { limit: 1301, newZone: "D1" },
  ],
  Cuenca: [
    { limit: 800, newZone: "D3" },
    { limit: 1050, newZone: "D2" },
    { limit: 1301, newZone: "E1" },
  ],
  Gipuzkoa: [
    { limit: 400, newZone: "D1" },
    { limit: 1301, newZone: "E1" },
  ],
  Girona: [
    { limit: 100, newZone: "C2" },
    { limit: 600, newZone: "D2" },
    { limit: 1301, newZone: "E1" },
  ],
  Granada: [
    { limit: 50, newZone: "A4" },
    { limit: 350, newZone: "B4" },
    { limit: 600, newZone: "C4" },
    { limit: 800, newZone: "C3" },
    { limit: 1250, newZone: "D3" },
    { limit: 1301, newZone: "E1" },
  ],
  Guadalajara: [
    { limit: 950, newZone: "D3" },
    { limit: 1000, newZone: "D2" },
    { limit: 1301, newZone: "E1" },
  ],
  Huelva: [
    { limit: 50, newZone: "A4" },
    { limit: 150, newZone: "B4" },
    { limit: 350, newZone: "B3" },
    { limit: 800, newZone: "C3" },
    { limit: 1301, newZone: "D3" },
  ],
  Huesca: [
    { limit: 200, newZone: "C3" },
    { limit: 400, newZone: "D3" },
    { limit: 700, newZone: "D2" },
    { limit: 1301, newZone: "E1" },
  ],
  Jaén: [
    { limit: 350, newZone: "B4" },
    { limit: 750, newZone: "C4" },
    { limit: 1250, newZone: "D3" },
    { limit: 1301, newZone: "E1" },
  ],
  León: [{ limit: 1301, newZone: "E1" }],
  Lleida: [
    { limit: 100, newZone: "C3" },
    { limit: 600, newZone: "D3" },
    { limit: 1301, newZone: "E1" },
  ],
  Lugo: [
    { limit: 500, newZone: "D1" },
    { limit: 1301, newZone: "E1" },
  ],
  Madrid: [
    { limit: 500, newZone: "C3" },
  ...
  Málaga: [
    { limit: 100, newZone: "A3" },
    { limit: 300, newZone: "B3" },
    { limit: 700, newZone: "C3" },
    { limit: 1301, newZone: "D3" },
  ],
  ...
  Murcia: [
    { limit: 100, newZone: "B3" },
    { limit: 550, newZone: "C3" },
    { limit: 1301, newZone: "D3" },
  ],
  Navarra: [
    { limit: 100, newZone: "C2" },
    { limit: 350, newZone: "D2" },
    { limit: 600, newZone: "D1" },
    { limit: 1301, newZone: "E1" },
  ],
  Ourense: [
    { limit: 150, newZone: "C3" },
    { limit: 300, newZone: "C2" },
    { limit: 800, newZone: "D2" },
    { limit: 1301, newZone: "E1" },
  ],
  Palencia: [
    { limit: 800, newZone: "D1" },
    { limit: 1301, newZone: "E1" },
  ],
  "Palmas, Las": [
    { limit: 350, newZone: "alpha3" },
    { limit: 750, newZone: "A2" },
    { limit: 1000, newZone: "B2" },
    { limit: 1301, newZone: "C2" },
  ],
  Pontevedra: [
    { limit: 350, newZone: "C1" },
    { limit: 1301, newZone: "D1" },
  ],
  "Rioja, La": [
    { limit: 200, newZone: "C2" },
    { limit: 700, newZone: "D2" },
    { limit: 1301, newZone: "E1" },
  ],
  Salamanca: [
    { limit: 850, newZone: "D2" },
    { limit: 1301, newZone: "E1" },
  ],
  ...
  Sevilla: [
    { limit: 200, newZone: "B4" },
    { limit: 1301, newZone: "C4" },
  ],
  Soria: [
    { limit: 750, newZone: "D2" },
    { limit: 800, newZone: "D1" },
    { limit: 1301, newZone: "E1" },
  ],
  Tarragona: [
  ...
  Teruel: [
    { limit: 450, newZone: "C3" },
    { limit: 500, newZone: "C2" },
    { limit: 1000, newZone: "D2" },
    { limit: 1301, newZone: "E1" },
  ],
  Toledo: [
    { limit: 500, newZone: "C4" },
    { limit: 1301, newZone: "D3" },
  ],
  "Valencia/València": [
    { limit: 50, newZone: "B3" },
    { limit: 500, newZone: "C3" },
    { limit: 950, newZone: "D2" },
    { limit: 1301, newZone: "E1" },
  ],
  Valladolid: [
    { limit: 800, newZone: "D2" },
...
async function fetchCatastroCoordinatesXml(catastroUrl: string): Promise<string> {
  ...
  throw lastError instanceof Error
    ? lastError
    : new Error("No fue posible consultar coordenadas en Catastro");
}

export async function fetchAltitudeAndProvince(
  rc: string,
  prov: string,
  _muni: string
): Promise<{
  ...
  zone: string | null;
  zoneProvince: string | null;
  detectedProvince: string | null;
}> {
  if (!rc || rc.length < 14) {
    return { altitude: null, zone: null, zoneProvince: null, detectedProvince: null };
  }
  ...
  try {
    ...
    if (!coordinates) {
      ...
      return {
        ...
        zone: null,
        zoneProvince: null,
        detectedProvince: detectedProvince || null,
      };
    }
    ...
    const zoneProvince = (prov || detectedProvince || "").trim();
    if (altitude !== null) {
      zone = obtenerZona(zoneProvince, altitude);
    }

    return {
      altitude,
      zone,
      zoneProvince: zoneProvince || null,
      detectedProvince: detectedProvince || null,
    };
  } catch (err) {
