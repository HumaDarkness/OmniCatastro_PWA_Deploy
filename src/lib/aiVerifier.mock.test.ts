...
const simulateAiAudit = async (draft: MockDraft, imageUrls: string[]) => {
    ...
    if (supafilLayer && Math.abs(supafilLayer.r_valor - valueInImage) > 0.001) {
        return {
            ...
            suggestion: "Actualiza el valor de R a 5.111 para que coincida con la captura de la librería de cerramientos de CE3X."
        };
    }
...
(async () => {
    ...
    const mockScreenshots = [
        "https://supabase.../captura_ce3x_supafil.png"
    ];
