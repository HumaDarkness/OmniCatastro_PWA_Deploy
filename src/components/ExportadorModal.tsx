            ...
            <div className="bg-[#0a0a1a] border border-indigo-500/20 rounded-xl max-w-md w-full shadow-2xl overflow-hidden shadow-indigo-500/10 animate-in fade-in zoom-in-95">
                ...
                <div className="p-6">
                    <p className="text-sm text-slate-400 mb-6 relative">
                        La ciudad ya se ha preajustado a <strong>MADRID</strong>. Revisa o edita la fecha del certificado antes de generarlo.
                    </p>

                    <div className="space-y-4">
                        <div>
                            <label className="block text-xs font-semibold text-slate-500 mb-1.5 ml-1">Fecha Emisión</label>
