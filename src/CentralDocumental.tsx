              ...
              <Table>
                <TableHeader className="bg-slate-900/80 sticky top-0 z-10 backdrop-blur-sm">
                  <TableRow className="border-slate-800 hover:bg-transparent">
                    <TableHead className="text-slate-400 font-semibold w-[250px]">
                      Nombre del Producto
                    </TableHead>
                    ...
                    <TableHead className="text-slate-400 font-semibold text-center">
                      ...
                      >
                        <Beaker className="w-4 h-4" /> Lambda (λ)
                      </span>
                    </TableHead>
                ...
                <TableBody>
                  {materialesFiltrados.map((mat) => (
                    ...
                    >
                          ...
                          <div className="flex flex-wrap gap-1 mt-1.5">
                            {mat.tags.map((tag) => (
                              <Badge
                                key={tag}
                                variant="secondary"
                                className="text-[10px] bg-slate-800 text-slate-400 hover:bg-slate-700"
                              >
                                {tag}
                              </Badge>
                            ))}
                      ...
                      <TableCell className="text-slate-400">{mat.tipo_material}</TableCell>
